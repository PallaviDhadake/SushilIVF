	<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/MasterAdmin.master" AutoEventWireup="true" CodeFile="news-master.aspx.cs" Inherits="adminpanel_Default2" %>
			...
			<div class="card-body">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<asp:TextBox ID="txtNwsDesc" runat="server" CssClass="form-control textarea" Height="200px" Width="100%"  textmode="MultiLine" MaxLength="50"></asp:TextBox>
					</div>
