...
{
    iClass c = new iClass();
    public string pgTitle, nwsPhoto, prodPhoto, rootPath;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //    if (lblId.Text == "[New]")
            //    {
            //        ScriptManager.RegisterClientScriptBlock(this, GetType(), "myScript", "TostTrigger('waring', 'Add Documnet');", true);
            //        return;
            ...
            if (lblId.Text == "[New]")
            {
                c.ExecuteQuery("Insert into News(newsId, newsTitle, newsData, newsDate, newsImage, readCount, delMark)Values(" + maxId + ", '" + txtNwsTitl.Text + "', '" + txtNwsDesc.Text + "', '" + appDate + "', '" + nwsPhoto + "', 0, 0)");
            ...
            {
                c.ExecuteQuery("Update News set newsId=" + maxId + ", newsTitle='" + txtNwsTitl.Text + "', newsData='" + txtNwsDesc.Text + "' where newsId=" + maxId);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, GetType(), "myScript", "TostTrigger('success', 'News Deleted');", true);
            ScriptManager.RegisterClientScriptBlock(this, GetType(), "CallMyFunction", "waitAndMove('news-master.aspx', 2000);", true);
        }
        catch (Exception ex)
        {
